                ...
                <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                    ...
                    <div className="bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="p-5">
                            <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="#">Kevin Gomez</a>
                            </h3>
                            <span className="text-gray-500 dark:text-gray-400">Web Developer</span>
                            <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
                                Top 10 mejores desarrolladores del mundo, guapo, fuerte e inteligente.
                            </p>
                            <ul className="flex space-x-4 sm:mt-0">
                                ...
                                <li>
                                    <a href="https://github.com/KleroiG" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <div className="bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="p-5">
                            ...
                            <span className="text-gray-500 dark:text-gray-400">Web Developer</span>
                            <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
                            ¿Pequeño? Más bien soy un 'mini-maestro' en el arte del desarrollo web.
                            </p>
                            <ul className="flex space-x-4 sm:mt-0">
                                <li>
                                    <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
